...
public class CrazyTokenTemplate : ITemplate
{
    ...
    public CrazyTokenTemplate(string name, int numberPlayers, int maxToken, List<IStrategy> strategies, List<Team> teams, bool singlePlayer, bool humanPlay, HumanPlayerMenu humanMenu)
    {
        Title = name;
        ...
        {
            Random rand = new();
            listPlayers[rand.Next(5)] = new HumanPlayer(strategies[0]);
        }
        ...
        // Judge
        OverRound winB = RoundOvers.CrazyTokenOverRound;
        ...
        Tournament = new Tournament(new TournamentSetting(players, maxToken, numberPlayers, 600, judge, teams, humanMenu));
